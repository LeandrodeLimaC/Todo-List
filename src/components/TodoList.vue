    ...
    data(){
        return{
            todos: [
                ...
                {todoString: "Mock-up with really long text (Does text wrap/truncate/etc.)", completed : false},
                {todoString: "Show interactivity (Dropdowns/mobile navigation/etc)", completed : false},
                {todoString: "Blank states", completed : false},
                {todoString: "Show end of lists (pagination/continuous scrolling)", completed : false},
                {todoString: "Show end of page (footer/padding/etc)", completed : false},
                {todoString: "Scrolling behavior (static/fixed elements/etc)", completed : false},
                {todoString: "Unsplash image links", completed : false},
